					...
					<div className="grid items-center sm:grid-cols-2">
						...
						<div className="mx-auto mt-6 max-w-lg space-y-6 text-center sm:mt-0 sm:text-left">
							...
							<p className="text-muted-foreground">
								Connect your accounting and payment platforms to automatically
								sync financial data. Your runway updates in real-time as
								transactions flow in—no manual entry needed.
							</p>
